...
export const EXPERIENCES = [
  {
    ...
    description:
      "After demonstrating my skills and contributions as an Entry-Level Developer, I was promoted to Junior Developer at RDF Feed, Livestock & Foods, Inc. In this role, I take on more responsibilities in backend development, API integrations, and system optimization. I work with Laravel 11, Node.js, and Express to develop scalable applications, leveraging MongoDB for efficient data management. My expertise extends to WordPress, WooCommerce, and WCFM multi-vendor, where I enhance e-commerce functionalities. I continue to refine my skills in API development and testing with Postman and Laravel API Toolkit, ensuring seamless performance and user experience.",
    technologies: [
      "Laravel 11",
      "Node JS",
      "Express",
...
export const PROJECTS = [
  ...
  },
  {
    ...
    image: [
      EatsQuick,
      EatsQuickSecondImage,
      EatsQuickThirdImage,
      EatsQuickFourthImage,
      EatsQuickFifthImage,
    ],
  ...
  },
  {
    ...
    image: [
      ...
      CustomerSatisfactionSurveySecondImage,
      CustomerSatisfactionSurveyFifthImage,
      CustomerSatisfactionSurveyThirdImage,
      CustomerSatisfactionSurveyFourthImage,
      CustomerSatisfactionSurveySixImage,
      CustomerSatisfactionSurveySevenImage,
    ],
  ...
  },
  {
    ...
    image: [
      ...
      LoanManagementSystemSecondImage,
      LoanManagementSystemThirdImage,
      LoanManagementSystemFourthImage,
      LoanManagementSystemFifthImage,
    ],
  ...
  },
  {
    ...
    image: [
      EDukasyon,
      EDukasyonSecondImage,
      EDukasyonThirdImage,
      EDukasyonFourthImage,
      EDukasyonFifthImage,
      EDukasyonSixImage,
      EDukasyonSevenImage,
    ],
